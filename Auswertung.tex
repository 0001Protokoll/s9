...
\label{Zusammenfassung}
	...
	\end{tabular}
\end{table}
Auf eine quantitative Fehlerbetrachtung ist an dieser Stelle verzichtet worden, da der Fehler des experimentellen Aufbaus einen großen Einfluss auf die Ergebnisse hat, jedoch nicht näher quantifiziert werden konnte. Ebenfalls lagen keine Literaturwerte für die zu untersuchten Laser vor.
